...
exports.loadOsisTranslations = loadOsisTranslations;
exports.parseOsisXml = parseOsisXml;
exports.importOsisBibleFromFile = importOsisBibleFromFile;
...
async function loadOsisTranslations(osisPaths) {
    const results = [];
...
async function importOsisBibleFromFile(translationCode, language, filePath) {
    ...
    const xml = fs_1.default.readFileSync(filePath, 'utf8');
    ...
    const insertMany = db_1.db.transaction((versesToInsert) => {
