    ...
    const importSongs = async () => {
        try {
            ...
            for (const filePath of filePaths) {
                ...
                await window.worship.db.run('INSERT INTO song_sections (song_id, type, content, order_num) VALUES (?, ?, ?, ?)', [songId, 'Verse', sectionText, 1]);
