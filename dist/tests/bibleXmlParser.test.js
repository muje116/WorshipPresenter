...
const bibleXmlLoader_1 = require("../src/main/bibleXmlLoader");
describe('numbered Bible XML parser', () => {
    ...
    `;
        const bible = (0, bibleXmlLoader_1.parseBibleXml)(xml, 'EnglishGWBible.xml');
    ...
    test('maps the supplied translation names to unique codes', () => {
        ...
        const codes = names.map(([file, code]) => (0, bibleXmlLoader_1.parseBibleXml)(`<bible translation="${file.replace('.xml', '')}" />`, file).code);
